...
public class Zadacha6 {
    public static void main(String[] args) throws IOException {
        ...
        // napraviv nizi, i spored indekst, ke znam koj student e
        ...
        // ke napravam sega redici, i spored indeksot ke znam koj student e
        ...
        // sega ke gi polnam nizite i posle ke gi napolnam i redicite, vo istiot for
        for(int i=0;i<n;i++){
            names[i] = br.readLine();
        ...
        while(!queueSC.isEmpty() ||!queueSCF.isEmpty() || !queueHIST.isEmpty()){
            for(int i=0; i<2; i++){
                if(queueSC.isEmpty()){
                    break;
                }
